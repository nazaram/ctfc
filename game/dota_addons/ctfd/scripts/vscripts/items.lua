...
function OnAssignBlink(keys)
  local caster = keys.caster
  print(caster)
  local hero = EntIndexToHScript(keys.caster_entindex)
  print("in function OnAssignBlink")
  print(hero)
  UTIL_RemoveImmediate(keys.ability)
  if hero:IsRealHero() and hero:HasAbility("barebones_empty1") then
    print("true")
    hero:RemoveAbility("barebones_empty1")
    hero:AddAbility("old_antimage_blink"):SetLevel(1)
    --hero:SwapAbilities("barebones_empty1", "shredder_chain", true, false)
  elseif hero:IsRealHero() and hero:HasAbility("barebones_empty2") then
    print("true")
    hero:RemoveAbility("barebones_empty2")
...
function OnAssignSkewer(keys)
  local caster = keys.caster
  print(caster)
  local hero = EntIndexToHScript(keys.caster_entindex)
  print("in function Skewer")
  print(hero)
  UTIL_RemoveImmediate(keys.ability)
  if hero:IsRealHero() and hero:HasAbility("barebones_empty1") then
    print("true")
    hero:RemoveAbility("barebones_empty1")
    hero:AddAbility("magnataur_skewer"):SetLevel(1)
    --hero:SwapAbilities("barebones_empty1", "shredder_chain", true, false)
  elseif hero:IsRealHero() and hero:HasAbility("barebones_empty2") then
    print("true")
    hero:RemoveAbility("barebones_empty2")
...
function OnAssignSpikedCarapace(keys)
  local caster = keys.caster
  print(caster)
  local hero = EntIndexToHScript(keys.caster_entindex)
  print("in function SpikedCarapace")
  print(hero)
  UTIL_RemoveImmediate(keys.ability)
  if hero:IsRealHero() and hero:HasAbility("barebones_empty1") then
    print("true")
    hero:RemoveAbility("barebones_empty1")
    hero:AddAbility("nyx_assassin_spiked_carapace"):SetLevel(1)
    --hero:SwapAbilities("barebones_empty1", "shredder_chain", true, false)
  elseif hero:IsRealHero() and hero:HasAbility("barebones_empty2") then
    print("true")
    hero:RemoveAbility("barebones_empty2")
  ...
  function OnAssignTimeLapse(keys)
  local caster = keys.caster
  print(caster)
  local hero = EntIndexToHScript(keys.caster_entindex)
  print("in function lapse")
  print(hero)
  UTIL_RemoveImmediate(keys.ability)
  if hero:IsRealHero() and hero:HasAbility("barebones_empty1") then
    print("true")
    hero:RemoveAbility("barebones_empty1")
    hero:AddAbility("weaver_time_lapse"):SetLevel(1)
    --hero:SwapAbilities("barebones_empty1", "shredder_chain", true, false)
  elseif hero:IsRealHero() and hero:HasAbility("barebones_empty2") then
    print("true")
    hero:RemoveAbility("barebones_empty2")
  ...
  if hero:IsRealHero() and hero:HasAbility("barebones_empty1") then
    print("true")
    hero:RemoveAbility("barebones_empty1")
    hero:AddAbility("drow_ranger_wave_of_silence"):SetLevel(1)
    --hero:SwapAbilities("barebones_empty1", "shredder_chain", true, false)
  elseif hero:IsRealHero() and hero:HasAbility("barebones_empty2") then
    print("true")
    hero:RemoveAbility("barebones_empty2")
  ...
  function OnAssignSilence(keys)
  local caster = keys.caster
  print(caster)
  local hero = EntIndexToHScript(keys.caster_entindex)
  print("in function silence")
  print(hero)
  UTIL_RemoveImmediate(keys.ability)
  if hero:IsRealHero() and hero:HasAbility("barebones_empty1") then
    print("true")
    hero:RemoveAbility("barebones_empty1")
    hero:AddAbility("silencer_global_silence"):SetLevel(1)
    --hero:SwapAbilities("barebones_empty1", "shredder_chain", true, false)
  elseif hero:IsRealHero() and hero:HasAbility("barebones_empty2") then
    print("true")
    hero:RemoveAbility("barebones_empty2")
  ...
  function OnAssignCounterspell(keys)
  local caster = keys.caster
  print(caster)
  local hero = EntIndexToHScript(keys.caster_entindex)
  print("in function silence")
  ...
  if hero:IsRealHero() and hero:HasAbility("barebones_empty1") then
    print("true")
    hero:RemoveAbility("barebones_empty1")
    hero:AddAbility("antimage_counterspell"):SetLevel(1)
    --hero:SwapAbilities("barebones_empty1", "shredder_chain", true, false)
  elseif hero:IsRealHero() and hero:HasAbility("barebones_empty2") then
    print("true")
    hero:RemoveAbility("barebones_empty2")
  ...
  function OnAssignlightstrikearray(keys)
  local caster = keys.caster
  print(caster)
  local hero = EntIndexToHScript(keys.caster_entindex)
  print("in function silence")
  ...
  if hero:IsRealHero() and hero:HasAbility("barebones_empty1") then
    print("true")
    hero:RemoveAbility("barebones_empty1")
    hero:AddAbility("lina_light_strike_array"):SetLevel(1)
    --hero:SwapAbilities("barebones_empty1", "shredder_chain", true, false)
  elseif hero:IsRealHero() and hero:HasAbility("barebones_empty2") then
    print("true")
    hero:RemoveAbility("barebones_empty2")
  ...
  function OnAssignfissure(keys)
  local caster = keys.caster
  print(caster)
  local hero = EntIndexToHScript(keys.caster_entindex)
  print("in function fissure")
  print(hero)
  UTIL_RemoveImmediate(keys.ability)
  if hero:IsRealHero() and hero:HasAbility("barebones_empty1") then
    print("true")
    hero:RemoveAbility("barebones_empty1")
    hero:AddAbility("earthshaker_fissure"):SetLevel(1)
    --hero:SwapAbilities("barebones_empty1", "shredder_chain", true, false)
  elseif hero:IsRealHero() and hero:HasAbility("barebones_empty2") then
    print("true")
    hero:RemoveAbility("barebones_empty2")
